...
### [Software Assurance Training Voucher (SATV)-Programm im Partner Center](software-assurance-satv.md)
### [Verwenden des Voucher Validation and Redemption (VVR)-Tools im Partner Center, um Belege zu überprüfen, zu reservieren und einzulösen](voucher-validation-tool.md)
### [Häufig gestellte Fragen: Verwenden des Voucher Validation and Redemption (VVR)-Werkzeugs](vvr-faq.md)
### [Software Assurance Planning Services im Partner Center ](software-assurance-dps.md)
