...
### <a name="categories"></a><span data-ttu-id="b0aaa-107">Kategorien</span><span class="sxs-lookup"><span data-stu-id="b0aaa-107">Categories</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="b0aaa-155">Zielgruppe</span><span class="sxs-lookup"><span data-stu-id="b0aaa-155">Impacted audience</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="b0aaa-184">Zielgruppe</span><span class="sxs-lookup"><span data-stu-id="b0aaa-184">Impacted audience</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="b0aaa-196">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="b0aaa-196">Next steps</span></span>
...
<span data-ttu-id="b0aaa-207">Alle CSP-Partner</span><span class="sxs-lookup"><span data-stu-id="b0aaa-207">All CSP partners</span></span>
...
<span data-ttu-id="b0aaa-218">Im Rahmen unserer Verpflichtung, Partner und Kunden bei der Ausführung ihrer Geschäfte auf Vertrauensbasis zu unterstützen, werden wir ab dem 25. März 2021 zusätzliche Kundeninformationen anfordern.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-218">As part of our commitment to help partners and customers run their business based on trust, we will request additional customer information, effective March 25, 2021.</span></span>
...
2. <span data-ttu-id="b0aaa-226">Der Partner tätigt Geschäfte mit neuen Kunden oder Bestandskunden in den folgenden Ländern:</span><span class="sxs-lookup"><span data-stu-id="b0aaa-226">The partner does business with new or existing customers in the following countries:</span></span>
    ...
    - <span data-ttu-id="b0aaa-239">Venezuela</span><span class="sxs-lookup"><span data-stu-id="b0aaa-239">Venezuela</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="b0aaa-256">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="b0aaa-256">Next steps</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="b0aaa-316">Zielgruppe</span><span class="sxs-lookup"><span data-stu-id="b0aaa-316">Impacted audience</span></span>
...
### <a name="categories"></a><span data-ttu-id="b0aaa-326">Kategorien</span><span class="sxs-lookup"><span data-stu-id="b0aaa-326">Categories</span></span>
...
<span data-ttu-id="b0aaa-341">**Preisübersicht**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-341">**Pricing details**</span></span>
...
<span data-ttu-id="b0aaa-374">**SelfServePolicies – neue Funktionen hinzugefügt**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-374">**SelfServePolicies - new functionality added**</span></span>
...
### <a name="categories"></a><span data-ttu-id="b0aaa-388">Kategorien</span><span class="sxs-lookup"><span data-stu-id="b0aaa-388">Categories</span></span>
...
<span data-ttu-id="b0aaa-399">Die lizenzbasierten Preislisten vom Dezember enthalten die unten aufgeführten Angebote, die nicht in den Preislisten enthalten sein sollten.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-399">The December license-based price lists contain the below offers that should not be in the price lists.</span></span> <span data-ttu-id="b0aaa-400">Diese Angebote wurden zuvor irrtümlich in die Preislisten aufgenommen und sollten nicht veröffentlicht werden.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-400">These offers were previously included in the price lists in error and should not have been published.</span></span> <span data-ttu-id="b0aaa-401">Es gibt keinen Zeitplan, wann diese Angebote verfügbar sein werden.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-401">There is no schedule as to when these offers may be available.</span></span> <span data-ttu-id="b0aaa-402">Wenn Sie in Zukunft wieder hinzugefügt werden, werden sie als ADDs in zukünftigen Vorschaupreislisten aufgeführt.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-402">In the future, if they are added back they will be listed as ADDs in future preview price lists.</span></span>
   ...
   |<span data-ttu-id="b0aaa-403">**Angebotsname**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-403">**Offer name**</span></span>|<span data-ttu-id="b0aaa-404">**Angebots-ID**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-404">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="b0aaa-405">Dynamics 365 Human Resources (Preise für gemeinnützige Organisationen)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-405">Dynamics 365 Human Resources (Nonprofits Pricing)</span></span>|<span data-ttu-id="b0aaa-406">1596fa61-7da1-4263-98f8-b27dfa4cfbb5</span><span class="sxs-lookup"><span data-stu-id="b0aaa-406">1596fa61-7da1-4263-98f8-b27dfa4cfbb5</span></span>|
   |<span data-ttu-id="b0aaa-407">Dynamics 365 Human Resources Attach für qualifizierendes Dynamics 365-Basisangebot (Preise für gemeinnützige Organisationen)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-407">Dynamics 365 Human Resources Attach to Qualifying Dynamics 365 Base Offer (Nonprofits Pricing)</span></span>|<span data-ttu-id="b0aaa-408">8bf0b826-e05b-45aa-9cd1-9a9f742f7731</span><span class="sxs-lookup"><span data-stu-id="b0aaa-408">8bf0b826-e05b-45aa-9cd1-9a9f742f7731</span></span>|
   |<span data-ttu-id="b0aaa-409">Dynamics 365 Human Resources Attach für qualifizierendes Dynamics 365-Basisangebot (Preise für gemeinnützige Organisationen) (qualifiziertes Angebot)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-409">Dynamics 365 Human Resources Attach to Qualifying Dynamics 365 Base Offer (Nonprofits Pricing) (Qualified Offer)</span></span>|<span data-ttu-id="b0aaa-410">f906435d-9dc9-42ba-bea6-2a2b08ca60db</span><span class="sxs-lookup"><span data-stu-id="b0aaa-410">f906435d-9dc9-42ba-bea6-2a2b08ca60db</span></span>|
   |<span data-ttu-id="b0aaa-411">Dynamics 365 Human Resources Sandbox (Preise für gemeinnützige Organisationen)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-411">Dynamics 365 Human Resources Sandbox (Nonprofits Pricing)</span></span>|<span data-ttu-id="b0aaa-412">079ec5ba-d726-4384-95af-62d135c210d2</span><span class="sxs-lookup"><span data-stu-id="b0aaa-412">079ec5ba-d726-4384-95af-62d135c210d2</span></span>|
   |<span data-ttu-id="b0aaa-413">Dynamics 365 Human Resources Self Service (Preise für gemeinnützige Organisationen)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-413">Dynamics 365 Human Resources Self-Service (Nonprofits Pricing)</span></span>|<span data-ttu-id="b0aaa-414">931acecc-34c3-4f83-913e-c7fdbfd7e2a1</span><span class="sxs-lookup"><span data-stu-id="b0aaa-414">931acecc-34c3-4f83-913e-c7fdbfd7e2a1</span></span>|
   |<span data-ttu-id="b0aaa-415">Dynamics 365 Operations – Auftragspositionen (Preise für gemeinnützige Organisationen)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-415">Dynamics 365 Operations – Order Lines (Nonprofits Pricing)</span></span>|<span data-ttu-id="b0aaa-416">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span><span class="sxs-lookup"><span data-stu-id="b0aaa-416">7dd6b78a-3d53-47f8-8a64-bd84609a9a70</span></span>|
   
#### <a name="incorrect-offers-in-the-offer-list-matrix"></a><span data-ttu-id="b0aaa-417">Falsche Angebote in der Angebotslistenmatrix</span><span class="sxs-lookup"><span data-stu-id="b0aaa-417">Incorrect offers in the offer list matrix</span></span>
   
<span data-ttu-id="b0aaa-418">Die unten aufgeführten Angebote waren irrtümlich in der Angebotslistenmatrix enthalten.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-418">Below offers were in the offer list matrix in error.</span></span> <span data-ttu-id="b0aaa-419">Sie sind nicht verfügbar, und es gibt noch kein Zieldatum für die Verfügbarkeit.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-419">They are not available, there is not target date yet for availability.</span></span> <span data-ttu-id="b0aaa-420">Partner sollten diese Positionen ignorieren.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-420">Partners should ignore these line items.</span></span>

   |<span data-ttu-id="b0aaa-421">**Angebotsname**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-421">**Offer name**</span></span>|<span data-ttu-id="b0aaa-422">**Angebots-ID**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-422">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="b0aaa-423">Dynamics 365 Operations – Datenbankkapazität (Preise für gemeinnützige Organisationen)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-423">Dynamics 365 Operations - Database Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="b0aaa-424">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span><span class="sxs-lookup"><span data-stu-id="b0aaa-424">1d3f4d81-89b9-419e-a880-31b2c50b8d66</span></span>|
   |<span data-ttu-id="b0aaa-425">Dynamics 365 Operations – Dateikapazität (Preise für gemeinnützige Organisationen)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-425">Dynamics 365 Operations - File Capacity (Nonprofits Pricing)</span></span>|<span data-ttu-id="b0aaa-426">dc173a86-285b-444c-881e-3ece531f67da</span><span class="sxs-lookup"><span data-stu-id="b0aaa-426">dc173a86-285b-444c-881e-3ece531f67da</span></span>|

#### <a name="powerapps-offer"></a><span data-ttu-id="b0aaa-427">Power Apps-Angebot</span><span class="sxs-lookup"><span data-stu-id="b0aaa-427">Powerapps offer</span></span>

<span data-ttu-id="b0aaa-428">Dieses Angebot wurde in die Angebotslistenmatrix, jedoch nicht in der Preisliste vom Dezember aufgenommen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-428">This offer was included in the offer list matrix but not the December price list.</span></span> <span data-ttu-id="b0aaa-429">Das Angebot ist verfügbar, und die Preise sind in der November-Preislistendatei des Vormonats zu finden.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-429">The offer is available and pricing can be found in the previous month's price list November file.</span></span> <span data-ttu-id="b0aaa-430">Dieses Angebot sollte der Januar-Preisliste wieder hinzugefügt werden.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-430">This offer should be added back to the January price list.</span></span>

   |<span data-ttu-id="b0aaa-431">**Angebotsname**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-431">**Offer name**</span></span>|<span data-ttu-id="b0aaa-432">**Angebots-ID**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-432">**Offer ID**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="b0aaa-433">Power Apps nach App-Plan</span><span class="sxs-lookup"><span data-stu-id="b0aaa-433">Power Apps per app plan</span></span>|<span data-ttu-id="b0aaa-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span><span class="sxs-lookup"><span data-stu-id="b0aaa-434">5e1087b6-246b-4503-b88a-b60bdf0b3840</span></span>|

### <a name="next-steps"></a><span data-ttu-id="b0aaa-435">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="b0aaa-435">Next steps</span></span>

<span data-ttu-id="b0aaa-436">Überprüfen Sie regelmäßig die Versionshinweise, da bei Feststellung weiterer Probleme, diese an die Ankündigungen angehängt werden.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-436">Check release notes often as other issues are uncovered they will be appended to this announcement.</span></span>

### <a name="last-updated"></a><span data-ttu-id="b0aaa-437">Letzte Aktualisierung</span><span class="sxs-lookup"><span data-stu-id="b0aaa-437">Last updated</span></span>

<span data-ttu-id="b0aaa-438">8\. Dezember 2020</span><span class="sxs-lookup"><span data-stu-id="b0aaa-438">December 8, 2020</span></span>

______________

## <a name="an-update-of-the-us-microsoft-365-business-voice-with-calling-plan-offer-is-coming-soon"></a><a name="2"></a><span data-ttu-id="b0aaa-439">Aktualisierung des Angebots für Microsoft 365 Business Voice mit Anrufplan in den USA in Kürze verfügbar</span><span class="sxs-lookup"><span data-stu-id="b0aaa-439">An update of the US Microsoft 365 Business Voice with Calling Plan offer is coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="b0aaa-440">Kategorien</span><span class="sxs-lookup"><span data-stu-id="b0aaa-440">Categories</span></span>

- <span data-ttu-id="b0aaa-441">Datum: 03.12.2020</span><span class="sxs-lookup"><span data-stu-id="b0aaa-441">Date: 2020-12-3</span></span>
- <span data-ttu-id="b0aaa-442">Angebote/Märkte</span><span class="sxs-lookup"><span data-stu-id="b0aaa-442">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="b0aaa-443">Zusammenfassung</span><span class="sxs-lookup"><span data-stu-id="b0aaa-443">Summary</span></span> 

<span data-ttu-id="b0aaa-444">Am 1. Januar 2021 beginnt Microsoft damit, Partner und Kunden in den USA auf ein neues Angebot für Microsoft 365 Business Voice mit Anrufplan umzustellen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-444">On January 1, 2021, Microsoft will begin transitioning US partners and customers to a new Microsoft 365 Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="b0aaa-445">Es ist keine Maßnahme der Partner erforderlich.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-445">No partner action is required.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b0aaa-446">Zielgruppe</span><span class="sxs-lookup"><span data-stu-id="b0aaa-446">Impacted Audience</span></span> 

<span data-ttu-id="b0aaa-447">Alle Partner, die Transaktionen im Rahmen des CSP-Programms (Cloud Solution Provider) ausführen</span><span class="sxs-lookup"><span data-stu-id="b0aaa-447">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="b0aaa-448">Details</span><span class="sxs-lookup"><span data-stu-id="b0aaa-448">Details</span></span>

<span data-ttu-id="b0aaa-449">Microsoft ersetzt das bestehende Angebot für Business Voice mit Anrufplan in den USA durch ein neues Angebot, um interne Anforderungen für Telekommunikationsprodukte zu unterstützen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-449">Microsoft will replace the existing Business Voice with Calling plan offer in the US with a new offer to support internal requirements for telco products.</span></span> <span data-ttu-id="b0aaa-450">Das neue Angebot weist die gleichen Features und Preise auf.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-450">The new offer will have the same feature set and pricing.</span></span> <span data-ttu-id="b0aaa-451">Die Angebotsänderungen erfolgen intern bei Microsoft und sollten sich nicht auf Vermarktung, Verkauf oder Unterstützung der CSP-Partner für Business Voice mit Anrufplan auswirken.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-451">The offer changes are internal to Microsoft and should not affect the way that CSP partners market, sell, or support the Business Voice with Calling Plan offer.</span></span> <span data-ttu-id="b0aaa-452">Die Änderung gilt nur für dieses Angebot.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-452">The change will only apply to this offer.</span></span>

<span data-ttu-id="b0aaa-453">Bei neuen Verkäufen verwenden Sie das neue Angebot, das ab dem 1. Januar 2021 bereitsteht.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-453">For new sales, you will use the new offer starting on January 1, 2021.</span></span> <span data-ttu-id="b0aaa-454">Das alte Angebot wird durch das neue Angebot in der Preisliste ersetzt.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-454">The old offer will be replaced by the new offer on the price list.</span></span>

<span data-ttu-id="b0aaa-455">Bestandskunden werden am Verlängerungsdatum automatisch auf das neue Angebot umgestellt.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-455">Existing customers will be automatically transitioned to the new offer upon their renewal date.</span></span> <span data-ttu-id="b0aaa-456">Es ist keine Maßnahme der Partner und der Kunden bei der Verlängerung erforderlich.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-456">No action is required from partners and renewing customers.</span></span>


<span data-ttu-id="b0aaa-457">\*\*Neue Angebotsdetails</span><span class="sxs-lookup"><span data-stu-id="b0aaa-457">\*\*New offer details</span></span>
 
   |<span data-ttu-id="b0aaa-458">**Angebotsname**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-458">**Offer name**</span></span>|<span data-ttu-id="b0aaa-459">**Angebots-ID**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-459">**Offer ID**</span></span>|<span data-ttu-id="b0aaa-460">**Materialkennung**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-460">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="b0aaa-461">Microsoft 365 Business Voice (USA)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-461">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="b0aaa-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span><span class="sxs-lookup"><span data-stu-id="b0aaa-462">86713ec1-ad33-42cf-a1ce-8397d4d875fe</span></span>|<span data-ttu-id="b0aaa-463">PZW-00023</span><span class="sxs-lookup"><span data-stu-id="b0aaa-463">PZW-00023</span></span>|
   
<span data-ttu-id="b0aaa-464">\*\*Alte Angebotsdetails</span><span class="sxs-lookup"><span data-stu-id="b0aaa-464">\*\*Old offer details</span></span>

   |<span data-ttu-id="b0aaa-465">**Angebotsname**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-465">**Offer name**</span></span>|<span data-ttu-id="b0aaa-466">**Angebots-ID**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-466">**Offer ID**</span></span>|<span data-ttu-id="b0aaa-467">**Materialkennung**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-467">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="b0aaa-468">Microsoft 365 Business Voice (USA)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-468">Microsoft 365 Business Voice (US)</span></span>|<span data-ttu-id="b0aaa-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="b0aaa-469">9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>|<span data-ttu-id="b0aaa-470">PZW-00009</span><span class="sxs-lookup"><span data-stu-id="b0aaa-470">PZW-00009</span></span>|

### <a name="next-steps"></a><span data-ttu-id="b0aaa-471">Nächste Schritte</span><span class="sxs-lookup"><span data-stu-id="b0aaa-471">Next steps</span></span>

<span data-ttu-id="b0aaa-472">Machen Sie sich mit der Preisliste vertraut, und leiten Sie diese Informationen an alle zuständigen Mitarbeiter in Ihrer Organisation weiter.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-472">Familiarize yourself with the price list and share this information with all appropriate contacts in your organization.</span></span>

______________

## <a name="now-live-partner-center-api-updates-and-user-interface-enhancements-for-the-education-customer-validation-process"></a><a name="1"></a><span data-ttu-id="b0aaa-473">Jetzt verfügbar: Partner Center-API-Updates und Verbesserungen der Benutzeroberfläche für den Überprüfungsprozess für Kunden im Bildungswesen</span><span class="sxs-lookup"><span data-stu-id="b0aaa-473">Now live: Partner Center API updates and user interface enhancements for the Education customer validation process</span></span>

### <a name="categories"></a><span data-ttu-id="b0aaa-474">Kategorien</span><span class="sxs-lookup"><span data-stu-id="b0aaa-474">Categories</span></span>

- <span data-ttu-id="b0aaa-475">Datum: 03.12.2020</span><span class="sxs-lookup"><span data-stu-id="b0aaa-475">Date: 2020-12-3</span></span>
- <span data-ttu-id="b0aaa-476">Funktionen</span><span class="sxs-lookup"><span data-stu-id="b0aaa-476">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="b0aaa-477">Zielgruppe</span><span class="sxs-lookup"><span data-stu-id="b0aaa-477">Impacted Audience</span></span> 

<span data-ttu-id="b0aaa-478">Partner, die Angebote für Bildungseinrichtungen im Rahmen des Cloud Solution Provider-Programms vertreiben</span><span class="sxs-lookup"><span data-stu-id="b0aaa-478">Partners selling Academic offers through the Cloud Solution Provider program</span></span>

### <a name="summary"></a><span data-ttu-id="b0aaa-479">Zusammenfassung</span><span class="sxs-lookup"><span data-stu-id="b0aaa-479">Summary</span></span> 

<span data-ttu-id="b0aaa-480">Microsoft setzt auf Vertrauen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-480">Microsoft runs on trust.</span></span> <span data-ttu-id="b0aaa-481">Wir haben uns verpflichtet, eine kompatible und sichere Methode der Kundenüberprüfung zur Abwicklung von Angeboten für Bildungseinrichtungen im Cloud Solution Provider-Programm bereitzustellen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-481">We are committed to providing a compliant, safe, and secure method of customer validation for transacting Academic offers in the Cloud Solution Provider program.</span></span> <span data-ttu-id="b0aaa-482">Im Rahmen dieser Verpflichtung führen wir Verbesserungen der Partner Center-API und der Benutzeroberfläche ein. Diese werden für mehr Klarheit und Transparenz beim Prozess der Kundenüberprüfung sorgen sowie die Eingabe genauerer Daten ermöglichen und dadurch zu größerem Erfolg bei der Kundenüberprüfung beitragen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-482">As part of this commitment, we are introducing Partner Center API and user interface enhancements that will add clarity and visibility into the customer vetting process as well as the ability to input more accurate data, which will drive improved customer vetting success.</span></span> 

<span data-ttu-id="b0aaa-483">**Partner Center-Verbesserungen**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-483">**Partner Center enhancements**</span></span> 

- <span data-ttu-id="b0aaa-484">Neue GET- und POST-Qualifizierungs-APIs zur Unterstützung einer genauen Dateneingabe und Verbesserung des Überprüfungsprozesses für Kunden im Bildungswesen durch Microsoft.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-484">New GET and POST Qualifications APIs to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

- <span data-ttu-id="b0aaa-485">Verbesserungen der Benutzeroberfläche zur Unterstützung einer genauen Dateneingabe und Verbesserung des Überprüfungsprozesses für Kunden im Bildungswesen durch Microsoft.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-485">User interface enhancements to support accurate data entry and improve the Education customer validation process by Microsoft.</span></span> 

<span data-ttu-id="b0aaa-486">**Einstellung vorhandener GET- und PUT-Qualifizierungs-APIs**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-486">**Deprecation of existing GET and PUT Qualification APIs**</span></span> 

<span data-ttu-id="b0aaa-487">Die vorhandenen GET- und PUT-Qualifizierungs-APIs werden **vor Ende Februar 2021** eingestellt.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-487">The existing GET and PUT Qualification APIs will retire **before the end of February 2021**.</span></span> <span data-ttu-id="b0aaa-488">Ab diesem Zeitpunkt müssen Sie auf die neuen GET- und POST-APIs im Partner Center umgestellt haben, um Angebote für Bildungseinrichtungen erwerben zu können.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-488">At that time, you will need to have transitioned to the new GET and POST Partner Center APIs in order to be able to purchase Education offers.</span></span>  

<span data-ttu-id="b0aaa-489">**Testen**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-489">**Testing**</span></span> 

<span data-ttu-id="b0aaa-490">Um sich mit den APIs und der Dateneingabe vertraut zu machen, die für eine erfolgreiche Kundenüberprüfung erforderlich sind, können Partner diese Verbesserungen testen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-490">To gain a better understanding of the APIs and data entry required for successful customer validation, partners can test these enhancements.</span></span> <span data-ttu-id="b0aaa-491">Partner, die an den Tests teilnehmen möchten, sollten sich den [Testleitfaden für Kunden im Bildungswesen im Partner Center](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) herunterladen. Dieser enthält Anweisungen zur Vorbereitung und Registrierung sowie Informationen zu den erwarteten Abläufen während der Testphase.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-491">Partners who want to participate in the testing should download the [Partner Center Education customer testing guide](https://partner.microsoft.com/resources/detail/partner-center-edu-testing-guide-pdf) for directions on how to prepare, sign up, and for information on what to expect during the testing phase.</span></span>

<span data-ttu-id="b0aaa-492">**Kunden im Bereich Bibliotheken und Museen**</span><span class="sxs-lookup"><span data-stu-id="b0aaa-492">**Library and Museum customers**</span></span> 

<span data-ttu-id="b0aaa-493">Zusätzlich zu den oben genannten Verbesserungen freuen wir uns mitteilen zu können, dass Kunden im Bereich Bibliotheken und Museen Angebote zu Preisen für Bildungseinrichtungen bereitgestellt werden können. Dadurch wird die Kundenbasis im Bildungswesen ausgeweitet, mit der Sie CSP-Angebote abwickeln können.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-493">In addition to the above enhancements, we are excited to announce that we will enable Academic-priced offers for Library and Museum customers, expanding the Education customers with whom you can transact CSP offers.</span></span> 

<span data-ttu-id="b0aaa-494">Microsoft behält sich das Recht vor, den Status jedes Kunden oder vorgeschlagenen Kunden als qualifizierter Nutzer von Bildungsangeboten zu überprüfen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-494">Microsoft reserves the right to review the status of any customer or proposed customer as a qualified educational user.</span></span> <span data-ttu-id="b0aaa-495">Ausführliche Informationen dazu finden Sie unter den [Anforderungen für qualifizierte Nutzer für Forschung & Lehre](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span><span class="sxs-lookup"><span data-stu-id="b0aaa-495">See the [Academic Qualified Education User Requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) for full details.</span></span> 

### <a name="next-stepsadditional-resources"></a><span data-ttu-id="b0aaa-496">Nächste Schritte/zusätzliche Ressourcen</span><span class="sxs-lookup"><span data-stu-id="b0aaa-496">Next steps/additional resources</span></span>

- <span data-ttu-id="b0aaa-497">Informieren Sie sich über die neue Partner Center-Benutzeroberfläche, API-Änderungen und Anleitungen in den Operations Readiness-Ressourcen:  [Verbesserungen des Überprüfungsprozesses für Kunden im Bildungswesen im Partner Center](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/)</span><span class="sxs-lookup"><span data-stu-id="b0aaa-497">Review the new Partner Center User Interface, API changes, and Guide in the Operations Readiness resources:  [Partner Center Education customer validation](https://partner.microsoft.com/resources/collection/partner-center-edu-validation-enhancements#/) process enhancements</span></span> 

- <span data-ttu-id="b0aaa-498">Stellen Sie sicher, dass Ihre Organisation mit den [Anforderungen für qualifizierte Nutzer für Forschung & Lehre](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7) vertraut ist.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-498">Ensure your organization is familiar with the [Academic Qualified Education User requirements](https://www.microsoftvolumelicensing.com/DocumentSearch.aspx?Mode=3&DocumentTypeId=7).</span></span> 

- <span data-ttu-id="b0aaa-499">Leiten Sie diese Informationen an die entsprechenden Teams in Ihrer Organisation und Ihre Handelspartner weiter, um sie bei der Vorbereitung auf diese Änderungen zu unterstützen.</span><span class="sxs-lookup"><span data-stu-id="b0aaa-499">Share this information with the appropriate teams within your organization, and with your resellers, to help them prepare for these changes.</span></span> 

### <a name="change-log"></a><span data-ttu-id="b0aaa-500">Änderungsprotokoll</span><span class="sxs-lookup"><span data-stu-id="b0aaa-500">Change Log</span></span> 

<span data-ttu-id="b0aaa-501">_ 31. August 2020:  Erstveröffentlichung</span><span class="sxs-lookup"><span data-stu-id="b0aaa-501">_ August 31, 2020:  Original publication</span></span> 

- <span data-ttu-id="b0aaa-502">25. September 2020:  Aktualisierung des Testfensters hinzugefügt</span><span class="sxs-lookup"><span data-stu-id="b0aaa-502">September 25, 2020:  Test window update added</span></span> 

- <span data-ttu-id="b0aaa-503">4\. Oktober 2020: Erinnerung an das Registrieren für den Test</span><span class="sxs-lookup"><span data-stu-id="b0aaa-503">October 4, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="b0aaa-504">10. November 2020: Erinnerung an das Registrieren für den Test</span><span class="sxs-lookup"><span data-stu-id="b0aaa-504">November 10, 2020: Reminder to sign up for testing</span></span> 

- <span data-ttu-id="b0aaa-505">3\. Dezember 2020: API-Updates verfügbar</span><span class="sxs-lookup"><span data-stu-id="b0aaa-505">December 3, 2020: API updates live</span></span>