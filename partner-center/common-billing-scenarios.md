...
Nutzungsbasierte Abonnements werden monatlich zum Dauerauftragsdatum abgerechnet. Wenn beispielsweise das Abonnementdatum am 15. ist, werden Sie am 15. Januar für den Zeitraum vom 15. Dezember – 14. Januar belastet. Ihnen wird am 15. Februar für den Dienst Zeitraum 15. Januar – 14. Februar berechnet usw. Die Gebühren, die für das Abonnement Anniversary-Tag generiert werden, werden auf die folgende Datei von Rechnung und abstimmungsdatei angezeigt.

Sie können gelegentlich feststellen, dass einige Nutzungsgebühren Ihrer Rechnung fehlen, oder wird diese Verwendung von einem vorherigen Monat in Rechnung für den aktuellen Monat berechnet. Dies ist kein Fehler. Es bedeutet lediglich, dass der Dienst mit einem Zeitstempel versehen wurde, nachdem die Dienste aufgetreten ist. Verwendung, die innerhalb von 24 Stunden am Ende des Abrechnungszyklus erscheint auf den nächsten Monat verrechnet. 
...
**Abrechnung:** Lizenzbasierte Abonnements werden im Voraus für die Abonnement-Anniversary-Tag in Rechnung gestellt.

**Anniversary-Tag:** Der Anniversary-Tag wird der Tag des Monats, die Sie das Abonnement erworben haben. Wenn Sie das Abonnement am 15. Januar erworben haben, ist das Dauerauftragsdatum z. B. der 15. des Monats.

**Begriff:** Alle lizenzbasierte Abonnements haben eine kostenpflichtige Laufzeit von 12 Monaten, die auf dem Kaufdatum beginnt.

**Abbruch:** Abonnements, die in Monat 1 angehalten werden gutgeschriebenen 100 % festgelegt. Wird das Abonnement im 2-12 Monat storniert, wird der anteilige Betrag dem Abonnement gutgeschrieben.

**Erneuerung:** Alle lizenzbasierte Abonnements verlängert automatisch 12 Monate nach dem Beginn des kostenpflichtigen Begriffs.

## <a href="" id="licensebasedmonthly"></a>Monatliche Abrechnung-Szenarien
...
**Szenario 2: Lizenzanzahl ändern**
...
**Szenario 3: Vor 30 Tagen anhalten**
...
Am 1. Februar anhalten Sie ein Abonnement aus. Am 15. Februar enthält die lizenzbasierte Erstattungsdatei folgende Rechnungsposition:

|Startdatum der Abrechnung |Enddatum der Abrechnung |Gebührenart |Preis pro Einheit |Anzahl |Betrag |
|       :---:      |    :---:       | :---:      |:---:      |:---:    |:---:  |
13.01.2018|12. Februar 2018|Stornierungsgebühr|-4,00|1|-4,00

**Szenario 4: Anhalten nach 30 Tagen**
...
Aus diesem Grund den Einzelpreis =-1.716 (12 x 0.143 x (-1)).
...
**Szenario 2: Fügen Sie Lizenz hinzu, nach dem Jahrestag des Abonnements, aber vor Abrechnungsdatum**
...
**Szenario 3: Lizenzanzahl ändern**
...
**Szenario 4: Vor 30 Tagen anhalten**
...
**Szenario 5: Anhalten nach 30 Tagen**
...
**Szenario 6: Anhalten und reaktivieren**
