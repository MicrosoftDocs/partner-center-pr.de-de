---
title: Zusammenarbeiten mit indirekten Anbietern in CSP | Partner-Dashboard
...
Sie müssen den Benutzernamen und das Kennwort zur Anmeldung bei Office365, Microsoft Azure oder Microsoft Dynamics CRM angeben. Wenn Sie noch kein Geschäftskonto besitzen, können Sie dieses während der Registrierung erstellen. Wenn Sie nicht wissen, ob Sie bereits ein Geschäftskonto haben, finden Sie weitere Infos unter [Geschäftskonten und Partner-Dashboard](azure-active-directory-tenants-and-partner-center.md).
...
[Erfahren Sie mehr über Incentives im Partner-Dashboard](manage-your-incentives-in-partner-center.md)
