...
Zwei oder mehr Unternehmen, die aktive Microsoft-Partner sind und über Konten in Partner Center können ihre Konten zusammenführen.
...
- Die Partnerorganisation, die die Zusammenführung initiiert, ist das globale Partnerkonto (PGA).

- Die PGA der eingeladenen Organisation wird zu einem Standort des initiierenden Unternehmens.

- Alle Standorte des zusammenführenden Kontos werden zu Standorten unter der PGA.

- Sobald die Kontozusammenführung abgeschlossen ist, werden die Details des Kontos wie Standorte und Benutzer im PGA-Profil angezeigt. Sie können diesen Prozess nicht umkehren.

- Alle MPN-IDs für Speicherorte werden während dieser Konsolidierung beibehalten.

- Die Rollen des Benutzers werden übernommen. Wenn ein Benutzer beispielsweise der Incentivesadministrator für einen bestimmten Standort wäre, hätte er nach der Fusion weiterhin diese Rolle und kann die Incentives sehen, die er vor der Fusion gesehen hat.

- Azure AD Mandanten und CSP-Konten werden nicht zusammengeführt und haben keine Auswirkungen.

- Veröffentlichte Angebote und Co-Selling-Pipelinedaten, die beiden Unternehmen zugeordnet sind, werden beibehalten.
...
Wenn Sie die Einladung zum Zusammenführen von Konten annehmen möchten: · Ihre MPN-ID(s) und Standorte werden mit der PGA des Partnerkontos zusammengeführt, das Sie eingeladen hat.
...
- Markteinführungs- und technische Vorteile werden als Kompetenzkernvorteil angeboten. Nach der Zusammenführung wird empfohlen, ihre Bank- und Steuerinformationen zu überprüfen, um die Genauigkeit sicherzustellen.

- Wenn Sich Ihr Unternehmen im Azure Expert MSP Programm befindet, bleiben die Vorteile bis zur Verlängerung erhalten.

- Wenn Ihr Unternehmen erweiterte Spezialisierungen erworben hat, werden sie für beide Konten beibehalten.

- Alle Software Assurance-Gutscheine werden für beide Konten aufbewahrt. 
...
1. Wählen Sie in Ihrem Partner Center-Dashboard die Option **Einstellungen** aus. 

2. Wählen Sie **Konto zusammenführen** aus.

3. Fügen Sie die MPN-ID im Partnerprofil des **Kontos** hinzu, das Sie zum Zusammenführen mit Ihnen einladen möchten. Sie müssen die globale MPN-ID des Partners verwenden. Sie können keine STANDORT-MPN-ID verwenden.

4. Wenn Sie **Zusammenführen** auswählen, wird eine Einladung an das Partnerunternehmen gesendet. Wenn sie Ihre Anforderung akzeptieren, können Sie die Kontozusammenführung innerhalb Partner Center initiieren. Wenn das Unternehmen Ihre Anforderung zum Zusammenführen von Konten ablehnt, kann es erklären, warum die Anforderung abgelehnt wurde. Eine Liste aller Ihrer Kontozusammenführungen steht Ihnen unter **Mergeverlauf** zur Verfügung.
 
### <a name="example-of-two-companies-merging-accounts"></a>Beispiel für das Zusammenführen von Konten durch zwei Unternehmen
...
- [Hinzufügen Azure Partner Shared Services, damit Partner Azure-Abonnements für ihre eigene Verwendung erwerben können](shared-services.md)
