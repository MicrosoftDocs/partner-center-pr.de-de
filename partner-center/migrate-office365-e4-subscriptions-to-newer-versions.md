...
1. Klicken Sie im Menü " **Partner Center** " Wählen Sie **Kunden**, wählen Sie den Kunden, die, den Sie verschieben möchten, und wählen Sie dann die **Abonnements hinzufügen**.
...
1. Klicken Sie im Menü " **Partner Center** " Wählen Sie **Kunden**, wählen Sie den Kunden, die, den Sie verschieben möchten, und wählen Sie dann **Benutzer und Lizenzen**. Die Seite mit Benutzern und Lizenzen des Kunden wird geöffnet.
...
1. Wählen Sie aus dem Menü " **Partner Center** " **Kunden**. Wählen Sie den Kunden aus, den Sie verschieben möchten, und wählen Sie das Abonnement, das Sie stornieren möchten.
