...
- [Zugreifen auf diesen Bereich Partner Center](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#how-to-access-partner-contribution-indicators)
...
Wenn ein Partner z. B. bestimmte Auswirkungen in Key Indicators erzielt, kann der Partner die Kompetenz "Small and Midmarket Cloud Solutions" über die Cloud Business Applications SMB-Option erreichen (oder beibehalten).
...
|Funktion : Fachberater  | 30 Punkte  |
|Funktion: Entwickler  | 5 Punkte |
|Kundenerfolg– neue Bereitstellungen  | 20 Punkte  |
...
Partner können die maximale Punktzahl für eine Metrik erzielen, wenn sie die unten angegebenen Schwellenwerte erreichen oder übertreffen. Teilpunkte können für alle Metriken erhalten werden.
...
## <a name="prerequisites-to-receive-pci-credit-for-a-customer"></a>Voraussetzungen für den Erhalt eines PCI-Guthabens für einen Kunden

Bestimmte Partnerbeitragsindikatoren ermöglichen Ihnen nur dann den Empfang von Gutschrift für einen bestimmten Kunden, wenn Sie über eine bestimmte Partner-zu-Kunden-Zuordnung verfügen. Folgende Indikatoren oder PCI-Metriken sind von diesen Voraussetzungen erfüllt:
...
- Um fünf Berater zu erreichen, können Partner Berater mit beiden Zertifizierungstypen wie folgt mischen und ab suchen:
  ...
  Um die Zertifizierung "Finance and Operations Developer Associate" zu erhalten, muss eine Person diese Prüfungen bestehen:
  - MB-300<br/>
    **und** eine der folgenden Prüfungen:
  - MB-500 oder MB-700
...
### <a name="definitions-for-pci-metric-6---monthly-active-user-growth"></a>Definitionen für PCI-Metrik-#6: Monatliches Wachstum aktiver Benutzer

Das monatliche aktive Benutzerwachstum ist ein [Kundenerfolgsindikator.](partner-contribution-indicators-small-and-midmarket-cloud-business-option.md#pci-scoring-based-on-six-key-indicators) Die Punkte dieses Indikators werden für diese Kompetenz wie folgt berechnet:
...
- Der indikator für das monatliche aktive Benutzerwachstum vergleicht den aktuellen Monat mit einer Baseline von vor 12 Monaten. Für die Erreichung der Kompetenz "Gold" oder "Silber klein" und "Midmarket Cloud Solutions" über die Cloud Business Applications SMB-Option stehen maximal 25 Punkte zur Verfügung.
...
- Alle Partner, die einem kostenpflichtigen Abonnement unter einem Mandanten zugeordnet sind, erhalten eine Gutschrift für alle monatlich aktiven Benutzer, die über alle kostenpflichtigen Abonnements unter diesem Mandanten summiert werden.

## <a name="how-to-access-partner-contribution-indicators"></a>Zugreifen auf Partnerbeitragsindikatoren

In diesem Abschnitt wird beschrieben, wie Sie auf die Details der Partnerbeitragsindikatoren und den Partnerfortschritt zugreifen.

### <a name="access-partner-contribution-indicators"></a>Zugreifen auf Partnerbeitragsindikatoren

Führen Sie die folgenden Schritte aus, um ihre Partnerbeitragsindikatoren-Tabelle anzuzeigen:

1. Melden Sie sich beim Partner Center-[Dashboard](https://partner.microsoft.com/dashboard) an.

2. Wählen Sie im Navigationsmenü **MPN** und dann **Kompetenzen** aus.

3. Wählen Sie die Kompetenz **Small und Midmarket Cloud Solutions** aus, gefolgt von der Option Cloud Business Applications **SMB.**

4. Zeigen Sie im Abschnitt Zusammenfassung Ihren Bisherigen Fortschritt, Ihre Erfolge und die zugehörige Bewertung an.
