...
### <a name="example-2-partner-has-implemented-third-party-mfa-using-identity-federation"></a>Beispiel 2: Partner hat Drittanbieter-MFA mithilfe des Identitätsverbunds implementiert
...
### <a name="example-3-partner-hasnt-implemented-mfa"></a>Beispiel 3: Partner hat MFA nicht implementiert
...
- Das Ergebnis von [Testen der Sicherheitsanforderungen für Partner](/powershell/partnercenter/test-partner-security-requirements), das vom Drittanbieter-MFA-fähigen Konto ausgeführt wird.
