...
- **Geschätzte monatlichen Kosten der letzten 12 Monate**: Monatlicher Trend des geschätzten Dollarbetrags vor Steuern über den Zeitraum von 12 Monaten
...
- **Ablaufstatus**:
    ...
    - Nach 30 Tagen abgelaufen: Abonnements, die nach 30 Tagen ablaufen (das Enddatum des Abonnement liegt nach den nächsten 30 Tagen)

    - In 30 Tagen abgelaufen: Abonnements, die innerhalb von 30 Tagen ablaufen (das Enddatum des Abonnement liegt zwischen heute und den nächsten 30 Tagen)

-  **Abonnements Gesamt**: Abonnements im Status "aktiv", "in der Toleranz" oder "deaktiviert"

- **Neue (letzte 30 Tage)** : Neue Abonnement, die Kunden in den letzten 30 Tagen erworben haben
...
- **Geschützt Nutzungskosten von Azure-Ressourcen für den ausgewählten Zeitraum**: Geschützt Nutzungskosten auf der aktuellen Gebührenkarte für jede gemessene Ressource in jedem nutzungsbasierten Abonnement für den ausgewählten Zeitraum innerhalb der letzten 60 Tage. 
