...
Nachfolgend finden Sie Antworten auf häufig gestellte Fragen zur Einrichtung von Konten und Identitäten.

### <a name="what-is-an-azure-active-directory-azure-ad-work-account"></a>Was ist ein Azure AD-Geschäftskonto (Azure Active Directory)?
...
### <a name="what-account-should-you-sign-into-partner-center-with-if-you-have-an-aad-tenant-with-microsoft-for-office-365-for-example-and-you-also-have-a-tenant-for-your-csp-business"></a>Mit welchem Konto sollten Sie sich beim Partner Center anmelden, wenn Sie über einen AAD-Mandanten bei Microsoft (z. B. für Office 365) und zusätzlich über einen Mandanten für Ihr CSP-Geschäft verfügen?
...
### <a name="what-happens-to-my-users-roles-when-they-move-from-pmc-to-partner-center"></a>Was geschieht mit den Rollen meiner Benutzer, wenn sie von PMC zu Partner Center wechseln?

Mit Ausnahme des globalen MPN-Administrators oder primären Programmkontakts, der die Migration durchführt, verlieren alle Benutzer in PMC Ihre Administratorrollen. Die Person, die die Migration abschließt, muss Rollen in Partner Center zuweisen. Die Rollen in Partner Center unterscheiden sich von den Rollen in PMC. Weitere Informationen zu Benutzerrollen in Partner Center finden Sie unter [Zuweisen von Rollen und Berechtigungen zu Benutzern] (permissions-overview.md) und [Wechsel von PMC zu Partner Center](move-pmc-pc-map.md#user-roles).

### <a name="whats-the-difference-between-my-company-profile-and-my-business-profile"></a>Worin besteht der Unterschied zwischen meinem Unternehmensprofil und meinem Geschäftsprofil?
...
### <a name="what-does-account-consolidation-mean-for-my-account"></a>Was bedeutet Kontokonsolidierung für mein Konto?
...
### <a name="if-i-have-multiple-aad-tenants-and-a-single-mpn-account-is-it-possible-to-link-them-in-partner-center"></a>Wenn ich mehrere AAD-Mandanten und ein MPN-Konto verwende, ist es dann möglich, diese in Partner Center zu verknüpfen?
...
### <a name="are-there-restrictions-to-adding-multiple-azure-ad-tenants-to-a-single-partner-center-account"></a>Gibt es Einschränkungen beim Hinzufügen mehrerer Azure AD-Mandanten zu einem einzelnen Partner Center-Konto?
...
Nachfolgend finden Sie Antworten auf häufig gestellte Fragen zur Migration der MPN-Mitgliedschaft.

### <a name="who-can-perform-the-move-from-pmc-to-partner-center"></a>Wer kann die Umstellung von PMC auf Partner Center durchführen?
...
### <a name="will-the-person-completing-the-migration-become-the-primary-contact-on-the-company-legal-profile-in-partner-center"></a>Wird die Person, die die Migration durchführt, zum primären Kontakt im rechtlichen Profil des Unternehmens in Partner Center?
...
### <a name="can-microsoft-migrate-my-mpn-membership-for-me"></a>Kann Microsoft meine MPN-Mitgliedschaft für mich migrieren?
...
### <a name="how-will-the-renewal-policy-change"></a>Wie ändert sich die Verlängerungsrichtlinie?

In Partner Center erstreckt sich das Verlängerungsfenster von Ihrem Jahrestag bis zu den folgenden 30 Tagen.

### <a name="will-our-competencies-remain-unchanged-after-we-move-to-partner-center"></a>Bleiben unsere Kompetenzen nach dem Wechsel zu Partner Center unverändert?
...
### <a name="will-my-benefits-including-cloud-benefits-technical-support-software-benefits-visual-studio-change-after-we-move"></a>Ändern sich meine Vorteile (z. B. Cloudvorteile, technischer Support, Softwarevorteile, Visual Studio) nach dem Umstieg?
...
### <a name="will-our-microsoft-accounts-that-have-visual-studio-benefits-allocations-be-honored"></a>Werden unsere Microsoft-Konten, die über Visual Studio-Vorteile verfügen, berücksichtigt?
...
### <a name="how-should-we-manage-our-mcp-associations-and-our-partner-university-access"></a>Wie sollten wir unsere MCP-Zuordnungen und unseren Partner University-Zugang verwalten?
...
### <a name="how-do-i-view-mcp-information-once-i-move-to-partner-center"></a>Wie zeige ich nach dem Umstieg auf Partner Center MCP-Informationen an?
...
### <a name="are-customer-references-used-in-partner-center"></a>Werden in Partner Center Kundenreferenzen verwendet?
...
### <a name="what-are-the-incentive-roles-in-partner-center"></a>Was sind die Incentiverollen im Partner Center?
...
### <a name="can-incentives-admins-be-assigned-at-the-global-and-location-level"></a>Können Incentiveadministratoren auf globaler Ebene und auf Standortebene zugewiesen werden?
...
### <a name="can-incentives-be-paid-at-the-global-or-location-level"></a>Können Incentives auf globaler Ebene oder auf Standortebene bezahlt werden?

Incentives werden nur auf Standortebene bezahlt.

### <a name="regarding-referrals-how-many-business-profiles-can-we-create"></a>Wie viele Geschäftsprofile können wir in Bezug auf Empfehlungen erstellen?
...
### <a name="how-will-referrals-be-assigned-what-changes-can-i-expect-for-example-if-i-have-a-global-company-in-one-market-and-locations-in-other-markets-how-will-referrals-be-assigned"></a>Wie werden Empfehlungen zugewiesen, und welche Änderungen muss ich erwarten? Wenn ich beispielsweise ein globales Unternehmen in einem Markt und Standorte in anderen Märkten habe, wie werden Empfehlungen dann zugewiesen?
...
### <a name="i-am-migrating-to-partner-center-from-within-russia-i-get-an-error-message-about-web-direct-how-do-i-continue-with-the-migration"></a>Ich migriere in Russland zum Partner Center und erhalte eine Fehlermeldung zu Web Direct. Wie kann ich die Migration fortsetzen?
