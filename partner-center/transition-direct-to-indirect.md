...
ms.locfileid: "9024912"
---
## <a name="transition-from-cloud-solution-provider-csp-direct-bill-partner-to-csp-indirect-reseller"></a>Übergang von der Cloud Solution Provider (CSP) direkte Rechnung-Partner, indirekter CSP-Händler 
...
2. Wählen Sie für einen Kunden zu bitten, eine vertriebspartnerschaft mit Ihnen und dem indirekten Anbieter zur gleichen Zeit können **neue Kunden zu bitten** . Der Anbieter muss über eine vertriebspartnerschaft mit Ihrem Kunden verfügen, damit er Aufträge im Namen des Kunden übermitteln kann, wenn der Kunde auf dieser neue Abonnements erwerben oder bereits vorhandenen Abonnements neue Lizenzen hinzufügen möchte.
...
**Direkte Rechnung Kunden (Punkte, die nicht als indirekter Vertriebspartner ausführen)**
...
**Um Kunden zu identifizieren, die Sie als Online-Dienst-Partner erworben haben**

1. Wählen Sie **Kunden**

2. Wählen Sie einen Kunden, die Details anzeigen
...
## <a name="enroll-for-indirect-reseller-incentives"></a>Für Anreize indirekter Wiederverkäufer registrieren 
