...
Mit dieser Option können Sie die Zahlungen, die Sie in Ihrer Bank für ein bestimmtes Programm erhalten haben, sowie die zugehörigen Steuern und den aggregierten Erwerbs Betrag herunterladen.
...
Mit dieser Option können Sie jedes auf der Seite Transaktionsverlauf gelaufene Zeilen Element herunterladen, den Typ, das Datum, die zugehörige Transaktions Menge, den Kunden, das Produkt und andere Transaktionsdetails, die für das Programm "Incentives" gelten.
...
|transaktioncountrycode   |Transaktion kauft/verkauft an Ländercode   |
...
|offerId   |TBD   |
|resellerId   |Reseller-Bezeichner   |
|resellerName   |Name des Wiederverkäufers   |
|verteilbare d   |Verteiler Bezeichner   |
|Distributor Name   |Verteiler Name   |
