...
|Letzte Zahlung           |Der Umfang (in US-Dollar), Name des Programms und MPN-ID Ihrer letzten Zahlung.                                      |
...
|**Gibt an, dass status** |**Reason** |**Partner-Aktion erforderlich?**       |
|------------------|:-------------------------------------|:-------------------------------------|
...
|Während der Überprüfung abgelehnt        |Die Zahlung wurde während der Überprüfung abgelehnt.          |Weitere Informationen erhalten Sie Support von Microsoft         |
|Failed        |Die Zahlung konnte aufgrund eines Fehlers der Microsoft-System nicht.         |Weitere Informationen erhalten Sie Support von Microsoft         |
...
|Steuer-Rechnung abgelehnt       |Ihre Rechnung Tax wurde während der Überprüfung abgelehnt. Alle ausstehenden Zahlungen werden angehalten, bis die Steuer Rechnung Überprüfung abgeschlossen ist.          |Weitere Informationen erhalten Sie Support von Microsoft         |
...
|participantIDType   |In der Regel MPN für Incentive Programme und Verkäufer-ID für Store-Programme      |
...
Diese Option bietet jedes ertragreiche Zeilenelements in die Transaktion-Verlaufsseite angezeigten gibt an, dass Typ, Datum, zugeordnete Transaktion Menge, Kunde, Produkt und andere transaktionale Details, die das Programm Anreize für Download.
...
|transactionDate   |Datum der Transaktion. Ist nützlich für Programme, in denen viele Transaktionen, die eine gibt an, dass beitragen.   |
...
|customerName   |Kundenname Transaktion   |


Zusätzlich zu der obigen Tabelle werden diese Transaktion Verlaufsfelder ggf. für die Anwendung zur Verfügung.

|**Spaltenname**   |**Beschreibung**   |
|------------------|:-------------------------------------|
|PartNumber   |Teilenummer, die mit der Transaktion verknüpft werden. Microsoft-Terminologie verwenden.   |
|productName   |Name der Produktreihe Transaktion eingebunden   |
|invoiceNumber   |Rechnungsnummer   |
|subscriptionId   |Abonnement-ID, die mit dem Kunden verknüpft ist   |
|subscriptionStartDate   |Startdatum des Abonnements   |
|subscriptionEndDate   |Enddatum des Abonnements   |
|offerId   |TBD   |
|resellerId   |Händler-ID   |
|resellerName   |Name des Wiederverkäufers   |
|distributorId   |Verteiler-ID   |
|distributorName   |Name des Verteilers   |
